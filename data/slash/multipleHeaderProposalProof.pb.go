...
type MultipleHeaderProposalProof struct {
	...
	HeadersInfo HeaderInfoList `protobuf:"bytes,3,opt,name=HeadersInfo,proto3" json:"HeadersInfo"`
}
...
func (m *MultipleHeaderProposalProof) GetHeadersInfo() HeaderInfoList {
	if m != nil {
...
var fileDescriptor_afe79f980fc6faed = []byte{
	...
	0x1a, 0x98, 0x07, 0xe6, 0x80, 0x59, 0x10, 0xe5, 0x4a, 0xeb, 0x19, 0xb9, 0xa4, 0x7d, 0x71, 0x5b,
	0x24, 0xa4, 0xce, 0xc5, 0x12, 0x52, 0x59, 0x90, 0x2a, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x67, 0x24,
	0x0c, 0xd1, 0xa5, 0x17, 0x0c, 0xb2, 0x30, 0x33, 0x2f, 0x1d, 0x24, 0x15, 0x04, 0x56, 0x20, 0xa4,
	0xc1, 0xc5, 0xea, 0x93, 0x5a, 0x96, 0x9a, 0x23, 0xc1, 0x04, 0x56, 0x29, 0x04, 0x55, 0x19, 0x92,
	0x51, 0x94, 0x9a, 0x58, 0x02, 0x96, 0x09, 0x82, 0x28, 0x10, 0xb2, 0xe5, 0xe2, 0x86, 0xd8, 0x54,
	0xec, 0x99, 0x97, 0x96, 0x2f, 0xc1, 0xac, 0xc0, 0xa8, 0xc1, 0x6d, 0x24, 0x0a, 0x55, 0x0f, 0x91,
	0x01, 0x49, 0xf8, 0x64, 0x16, 0x97, 0x38, 0xb1, 0x9c, 0xb8, 0x27, 0xcf, 0x10, 0x84, 0xac, 0xde,
	...
	0x70, 0x4a, 0x62, 0x03, 0xdb, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x3e, 0xe3, 0x93, 0xda,
	0x61, 0x01, 0x00, 0x00,
}
...
func (this *MultipleHeaderProposalProof) String() string {
	...
	s := strings.Join([]string{`&MultipleHeaderProposalProof{`,
		...
		`HeadersInfo:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.HeadersInfo), "HeaderInfoList", "HeaderInfoList", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
