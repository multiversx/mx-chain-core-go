...
type HeaderV2 struct {
	...
	PreviousHeaderProof      *PreviousHeaderProof `protobuf:"bytes,8,opt,name=PreviousHeaderProof,proto3" json:"previousHeaderProof"`
}
...
func (m *HeaderV2) GetPreviousHeaderProof() *PreviousHeaderProof {
	if m != nil {
...
type PreviousHeaderProof struct {
...
func (m *PreviousHeaderProof) Reset()      { *m = PreviousHeaderProof{} }
func (*PreviousHeaderProof) ProtoMessage() {}
func (*PreviousHeaderProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_17a3844aa051366e, []int{3}
}
func (m *PreviousHeaderProof) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PreviousHeaderProof) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *PreviousHeaderProof) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PreviousHeaderProof.Merge(m, src)
}
func (m *PreviousHeaderProof) XXX_Size() int {
	return m.Size()
}
func (m *PreviousHeaderProof) XXX_DiscardUnknown() {
	xxx_messageInfo_PreviousHeaderProof.DiscardUnknown(m)
}

var xxx_messageInfo_PreviousHeaderProof proto.InternalMessageInfo

func (m *PreviousHeaderProof) GetPubKeysBitmap() []byte {
	if m != nil {
...
func (m *PreviousHeaderProof) GetAggregatedSignature() []byte {
	if m != nil {
...
func (*HeaderProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_17a3844aa051366e, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*PreviousHeaderProof)(nil), "proto.PreviousHeaderProof")
...
var fileDescriptor_17a3844aa051366e = []byte{
	...
	,
}
...
func (this *PreviousHeaderProof) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*PreviousHeaderProof)
	if !ok {
		that2, ok := that.(PreviousHeaderProof)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *PreviousHeaderProof) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&block.PreviousHeaderProof{")
...
func (m *PreviousHeaderProof) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PreviousHeaderProof) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PreviousHeaderProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PreviousHeaderProof) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *HeaderV2) String() string {
	...
	s := strings.Join([]string{`&HeaderV2{`,
		...
		`PreviousHeaderProof:` + strings.Replace(this.PreviousHeaderProof.String(), "PreviousHeaderProof", "PreviousHeaderProof", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PreviousHeaderProof) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PreviousHeaderProof{`,
...
func (m *PreviousHeaderProof) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PreviousHeaderProof: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PreviousHeaderProof: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
