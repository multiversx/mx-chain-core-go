...
type SovereignChainHeader struct {
	...
	MainChainShardHeaderHashes [][]byte `protobuf:"bytes,3,rep,name=MainChainShardHeaderHashes,proto3" json:"MainChainShardHeaderHashes,omitempty"`
}
...
func (m *SovereignChainHeader) GetMainChainShardHeaderHashes() [][]byte {
	if m != nil {
		return m.MainChainShardHeaderHashes
	}
	return nil
}
...
var fileDescriptor_b9b8ff297a820152 = []byte{
	...
	0x1c, 0xa5, 0xad, 0x8c, 0x5c, 0x22, 0xc1, 0x58, 0x6c, 0x10, 0x52, 0xe5, 0x62, 0x83, 0xb0, 0x24,
	...
	0x1c, 0xb2, 0x42, 0x76, 0x5c, 0x52, 0xbe, 0x89, 0x99, 0x10, 0x1b, 0x83, 0x33, 0x12, 0x8b, 0x52,
	0x20, 0xe6, 0x81, 0xe4, 0x52, 0x8b, 0x25, 0x98, 0x15, 0x98, 0x35, 0x78, 0x82, 0xf0, 0xa8, 0x70,
	0xb2, 0xbf, 0xf0, 0x50, 0x8e, 0xe1, 0xc6, 0x43, 0x39, 0x86, 0x0f, 0x0f, 0xe5, 0x18, 0x1b, 0x1e,
	0xc9, 0x31, 0xae, 0x78, 0x24, 0xc7, 0x78, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x37,
	0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0xf8, 0xe2, 0x91, 0x1c, 0xc3, 0x87, 0x47, 0x72, 0x8c,
	0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x14, 0x2b, 0xd8,
	0xfb, 0x49, 0x6c, 0x60, 0xef, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x1b, 0x5e, 0xff, 0xd4,
	0x60, 0x01, 0x00, 0x00,
}
...
func (this *SovereignChainHeader) Equal(that interface{}) bool {
	...
	if len(this.MainChainShardHeaderHashes) != len(that1.MainChainShardHeaderHashes) {
		return false
	}
	for i := range this.MainChainShardHeaderHashes {
		if !bytes.Equal(this.MainChainShardHeaderHashes[i], that1.MainChainShardHeaderHashes[i]) {
			return false
		}
	}
	return true
...
func (m *SovereignChainHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MainChainShardHeaderHashes) > 0 {
		for iNdEx := len(m.MainChainShardHeaderHashes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.MainChainShardHeaderHashes[iNdEx])
			copy(dAtA[i:], m.MainChainShardHeaderHashes[iNdEx])
			i = encodeVarintSovereignChainHeader(dAtA, i, uint64(len(m.MainChainShardHeaderHashes[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *SovereignChainHeader) Size() (n int) {
	...
	if len(m.MainChainShardHeaderHashes) > 0 {
		for _, b := range m.MainChainShardHeaderHashes {
			l = len(b)
			n += 1 + l + sovSovereignChainHeader(uint64(l))
		}
	}
...
func (this *SovereignChainHeader) String() string {
	...
	s := strings.Join([]string{`&SovereignChainHeader{`,
		...
		`MainChainShardHeaderHashes:` + fmt.Sprintf("%v", this.MainChainShardHeaderHashes) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SovereignChainHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MainChainShardHeaderHashes", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MainChainShardHeaderHashes = append(m.MainChainShardHeaderHashes, make([]byte, postIndex-iNdEx))
			copy(m.MainChainShardHeaderHashes[len(m.MainChainShardHeaderHashes)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
