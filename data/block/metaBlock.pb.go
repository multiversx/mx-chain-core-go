...
type ShardData struct {
	...
	CurrentPubKeysBitmap  []byte            `protobuf:"bytes,15,opt,name=CurrentPubKeysBitmap,proto3" json:"currentPubKeysBitmap,omitempty"`
	CurrentSignature      []byte            `protobuf:"bytes,16,opt,name=CurrentSignature,proto3" json:"currentSignature,omitempty"`
}
...
func (m *ShardData) GetCurrentPubKeysBitmap() []byte {
	if m != nil {
		return m.CurrentPubKeysBitmap
	}
	return nil
}

func (m *ShardData) GetCurrentSignature() []byte {
	if m != nil {
		return m.CurrentSignature
	}
	return nil
}
...
var fileDescriptor_87b91ab531130b2b = []byte{
	...
	,
}
...
func (this *ShardData) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.CurrentPubKeysBitmap, that1.CurrentPubKeysBitmap) {
		return false
	}
	if !bytes.Equal(this.CurrentSignature, that1.CurrentSignature) {
		return false
	}
	return true
}
...
func (this *ShardData) GoString() string {
	...
	s = append(s, "CurrentPubKeysBitmap: "+fmt.Sprintf("%#v", this.CurrentPubKeysBitmap)+",\n")
	s = append(s, "CurrentSignature: "+fmt.Sprintf("%#v", this.CurrentSignature)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ShardData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CurrentSignature) > 0 {
		i -= len(m.CurrentSignature)
		copy(dAtA[i:], m.CurrentSignature)
		i = encodeVarintMetaBlock(dAtA, i, uint64(len(m.CurrentSignature)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
	}
	if len(m.CurrentPubKeysBitmap) > 0 {
		i -= len(m.CurrentPubKeysBitmap)
		copy(dAtA[i:], m.CurrentPubKeysBitmap)
		i = encodeVarintMetaBlock(dAtA, i, uint64(len(m.CurrentPubKeysBitmap)))
		i--
		dAtA[i] = 0x7a
	}
	{
...
func (m *ShardData) Size() (n int) {
	...
	l = len(m.CurrentPubKeysBitmap)
	if l > 0 {
		n += 1 + l + sovMetaBlock(uint64(l))
	}
	l = len(m.CurrentSignature)
	if l > 0 {
...
func (this *ShardData) String() string {
	...
	s := strings.Join([]string{`&ShardData{`,
		...
		`CurrentPubKeysBitmap:` + fmt.Sprintf("%v", this.CurrentPubKeysBitmap) + `,`,
		`CurrentSignature:` + fmt.Sprintf("%v", this.CurrentSignature) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ShardData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentPubKeysBitmap", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CurrentPubKeysBitmap = append(m.CurrentPubKeysBitmap[:0], dAtA[iNdEx:postIndex]...)
			if m.CurrentPubKeysBitmap == nil {
				m.CurrentPubKeysBitmap = []byte{}
			}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentSignature", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CurrentSignature = append(m.CurrentSignature[:0], dAtA[iNdEx:postIndex]...)
			if m.CurrentSignature == nil {
				m.CurrentSignature = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
