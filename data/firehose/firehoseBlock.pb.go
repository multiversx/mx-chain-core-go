...
type FirehoseBlock struct {
	...
	SignersIndicesBitmap []uint64                         `protobuf:"varint,12,rep,packed,name=SignersIndicesBitmap,proto3" json:"SignersIndicesBitmap,omitempty"`
}
...
func (m *FirehoseBlock) GetSignersIndicesBitmap() []uint64 {
	if m != nil {
...
var fileDescriptor_bd81671bd210eaed = []byte{
	...
	0x14, 0xc7, 0xad, 0xda, 0x69, 0xea, 0x27, 0xb7, 0x69, 0xd9, 0x0d, 0x10, 0x7c, 0x60, 0x3d, 0xa3,
	0xeb, 0x7c, 0x89, 0x0d, 0x78, 0x3b, 0x0c, 0x0b, 0xd0, 0xa1, 0x4a, 0xeb, 0xd5, 0x59, 0xb0, 0x75,
	0x8c, 0x87, 0x61, 0xc5, 0x80, 0x81, 0x96, 0x18, 0x59, 0x88, 0x22, 0x06, 0x24, 0xdd, 0xc6, 0xb7,
	...
	,
}
...
func (this *FirehoseBlock) Equal(that interface{}) bool {
	...
	if len(this.SignersIndicesBitmap) != len(that1.SignersIndicesBitmap) {
		return false
	}
	for i := range this.SignersIndicesBitmap {
		if this.SignersIndicesBitmap[i] != that1.SignersIndicesBitmap[i] {
			return false
		}
	}
	return true
...
func (m *FirehoseBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SignersIndicesBitmap) > 0 {
		dAtA2 := make([]byte, len(m.SignersIndicesBitmap)*10)
		var j1 int
		for _, num := range m.SignersIndicesBitmap {
			for num >= 1<<7 {
...
func (m *FirehoseBlock) Size() (n int) {
	...
	if len(m.SignersIndicesBitmap) > 0 {
		l = 0
		for _, e := range m.SignersIndicesBitmap {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType == 0 {
				...
				m.SignersIndicesBitmap = append(m.SignersIndicesBitmap, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SignersIndicesBitmap) == 0 {
					m.SignersIndicesBitmap = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
