...
type Transaction struct {
	...
	RelayedAddr       []byte        `protobuf:"bytes,16,opt,name=RelayedAddr,proto3" json:"relayer,omitempty"`
	InnerTransaction  *Transaction  `protobuf:"bytes,17,opt,name=InnerTransaction,proto3" json:"innerTransaction,omitempty"`
}
...
func (m *Transaction) GetRelayedAddr() []byte {
	if m != nil {
		return m.RelayedAddr
	}
	return nil
}

func (m *Transaction) GetInnerTransaction() *Transaction {
	if m != nil {
...
var fileDescriptor_2cc4e03d2c28c490 = []byte{
	...
	,
}
...
func (this *Transaction) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.RelayedAddr, that1.RelayedAddr) {
		return false
	}
	if !this.InnerTransaction.Equal(that1.InnerTransaction) {
		return false
	}
	return true
}
...
func (m *Transaction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.InnerTransaction != nil {
		{
			size, err := m.InnerTransaction.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.RelayedAddr) > 0 {
		i -= len(m.RelayedAddr)
		copy(dAtA[i:], m.RelayedAddr)
		i = encodeVarintTransaction(dAtA, i, uint64(len(m.RelayedAddr)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
...
func (this *Transaction) String() string {
	...
	s := strings.Join([]string{`&Transaction{`,
		...
		`RelayedAddr:` + fmt.Sprintf("%v", this.RelayedAddr) + `,`,
		`InnerTransaction:` + strings.Replace(this.InnerTransaction.String(), "Transaction", "Transaction", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Transaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelayedAddr", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RelayedAddr = append(m.RelayedAddr[:0], dAtA[iNdEx:postIndex]...)
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InnerTransaction", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InnerTransaction == nil {
				m.InnerTransaction = &Transaction{}
			}
			if err := m.InnerTransaction.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
